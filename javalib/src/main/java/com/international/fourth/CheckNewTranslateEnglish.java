 ...
 * @Date: 2018/6/19 0019
 */
public class CheckNewTranslateEnglish {

    /**
     * 翻译回来的中文文件路径
     * 中英文按行一一对应
     */
    public static final String TRANS_CHINESE_PATH = "/Users/shen/Documents/2dfire/international/11-26CN";

    /**
     * 翻译回来的英文文件路径
     * 中英文按行一一对应
     */
    public static final String TRANS_ENGLISH_PATH = "/Users/shen/Documents/2dfire/international/11-26EN";
...
//    private static final String DIRECT_FOLDER_VALUES_TH = "values-th-rTH";
    ...
    public static void main(String[] args) {
        CheckNewTranslateEnglish check = new CheckNewTranslateEnglish();
